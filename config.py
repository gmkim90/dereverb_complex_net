...
parser.add_argument('--use_s_std', default=True, type=str2bool) # corpus-level VN
parser.add_argument('--use_x_std', default=True, type=str2bool) # corpus-level VN
...
parser.add_argument('--w_init_std', default=0, type=float)
